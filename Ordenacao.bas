...
Attribute OrdenarMovimentos.VB_Description = "Ordena tabelas de Débitos e Cartão em ordem crescente de data."
...
Sub PuxarDataAtual()
Attribute PuxarDataAtual.VB_Description = "Traz a data atual para a coluna de débitos ou cartão."
